...
class GymInfoSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final viewModel = context.watch<LikedGymViewModel>();
    final gymDetailViewModel = context.watch<GymDetailViewModel>();
          ...
          Row(
            children: [
              ...
              RoundButtonStyle(
                child: IconButton(
                  icon: Icon(
                    viewModel.isGymLiked(gymInfo.name)
                        ? Icons.favorite
          ...
          DefaultTextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(gymDetailViewModel.formattedDistance),
              ],
            ),
          ),
        ],
